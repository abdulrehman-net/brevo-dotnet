...
/// </summary>
internal sealed class BrevoCrmHttpClient
{
    ...
    private readonly BrevoCrmOptions _options;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            throw new BrevoCrmApiException(response.StatusCode, responseBody);
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return result ?? throw new BrevoCrmApiException(response.StatusCode, responseBody);
    }
